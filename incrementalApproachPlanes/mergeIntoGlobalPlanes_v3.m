function [globalPlanes, bufferComposedPlanes] = mergeIntoGlobalPlanes_v3(localPlanes,globalPlanes, tao,...
    theta, lengthBoundsTop, lengthBoundsP, bufferComposedPlanes, tresholdsV,...
    planeModelParameters, gridStep, compensateFactor, cameraPosition)
%MERGEINTOGLOBALPLANES_V3 Perform merge btwn planes that belong to
%localPlanes and globalPlanes vectors
% Assumption: planes have the same type and or tilt
