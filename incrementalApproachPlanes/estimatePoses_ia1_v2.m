...
function estimatePoses_ia1_v2(sessionID, fileName, planeFilteringParameters, ...
...
%% forget old planes
        if mod(i,windowSize)==0 %& i>=2*windowSize
            ...
            globalPlanes=updatePresence_v3(globalPlanes,particlesVector,windowInit, keyframes(1), th_vigency);
        end
...
% merge between planes of localPlanes
...
% compute presence of a particle using localPlanes
        [particlesVector, localPlanes]= updateParticleVector(localPlanes,...
