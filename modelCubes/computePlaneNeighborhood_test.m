...
estimatedLengths=zeros(N_estimatedPlanes,4);%planeID L1mm L2mm d_nearestBox
for i=1:N_estimatedPlanes
    ...
    estimatedLengths(i,:)=[planeID L1mm L2mm d_nearestBox];
end
% sort gt data
...
d_nearestBox=norm(np_vector);
gtLengths=[keyBoxID, plane_gt.L1, plane_gt.L2 d_nearestBox];


% compute distance between reference and estimated features
for i=1:N_estimatedPlanes
    distanceFeat(i)=norm(gtLengths(2:4)-estimatedLengths(i,2:4));
end
