...
%%     load planes of frame i and save acceptedPlanes
    ...
    [myPlanes, acceptedPlanesByFrame, rejectedPlanesByFrame,...
        ...
        numberPlanes, scene, frame, parameters_PK, lengthBounds, groundNormal, groundD, 1);%mode: (0,1), (w/out previous knowledge, with previous knowledge)
...
%                 myPlanes, th_angle, localUnassignedP);
    cuboidDetection_naivy_v4(myPlanes, th_angle, localUnassignedP, conditionalAssignationFlag);
    localAssignedP=updateAssignedPlanes_v3(myPlanes);
...
%             myPlanes, th_angle,localAssignedP);
        cuboidDetection_naivy_v4(myPlanes, th_angle, localAssignedP, conditionalAssignationFlag);
        localAssignedP=updateAssignedPlanes_v3(myPlanes);
        localUnassignedP=setdiff_v2(globalAcceptedPlanes, localAssignedP);
        assignedPlanes=[];
        unassignedPlanes=[];
...
%             myPlanes, th_angle, localUnassignedP, localAssignedP);
        cuboidDetection_pair_v5(myPlanes, th_angle, localUnassignedP, localAssignedP, conditionalAssignationFlag);
        localAssignedP=updateAssignedPlanes_v3(myPlanes);
        localUnassignedP=setdiff_v2(globalAcceptedPlanes, localAssignedP);
        assignedPlanes=[];
        unassignedPlanes=[];
