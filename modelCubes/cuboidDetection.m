function [assignedPlanes unassignedPlanes]= cuboidDetection(myPlanes, th_angle, unassignedPlanes, initIndex, assignedPlanes )
...
if(isempty(assignedPlanes))
        %perform naivy cuboid detection between unassigned planes
        cuboidDetection_naivy(myPlanes, th_angle, unassignedPlanes+initIndex);
else
        %perform pair cuboid detection between assigned and unassigned planes
        cuboidDetection_pair(myPlanes, th_angle, unassignedPlanes+initIndex, assignedPlanes+initIndex)
end
