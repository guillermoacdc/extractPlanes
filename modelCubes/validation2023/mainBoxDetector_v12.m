...
%         groundNormal, groundD, 1);%mode: (0,1), (w/out previous knowledge, with previous knowledge)
    ...
    figure,
    myPlotPlanes_v2(myPlanes, acceptedPlanesByFrame)
...
%     cuboidDetection_naivy_v5(myPlanes, th_angle, localUnassignedP,...
...
%         localAssignedP=updateAssignedPlanes_v4(myPlanes);
%         localUnassignedP=setdiff_v2(globalAcceptedPlanes, localAssignedP);
        [localAssignedP, localUnassignedP] = cuboidDetectionAndUPdate_pair(myPlanes,...
            th_angle, localUnassignedP,...
            localAssignedP, conditionalAssignationFlag, globalAcceptedPlanes);
%         assignedPlanes=[];
%         unassignedPlanes=[];
    % 4. create boxes
        [localBoxes flagFirstBox]=createBoxes_v4(myPlanes,...
            localAssignedP, localBoxes);
    end
...
figure,
    myPlotPlanes_v2(myPlanes, globalAcceptedPlanes)
    title (['global accepted planes ' num2str(frame)])
