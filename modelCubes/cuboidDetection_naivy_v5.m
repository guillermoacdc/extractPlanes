function cuboidDetection_naivy_v5(myPlanes, th_angle, planesIDs, conditionalAssignationFlag)
...
% _v5 uses the structure myPlanes with the fields (1) camerapose, (2) values
