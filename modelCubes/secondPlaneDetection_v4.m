function [secondPlaneIndex detectionFlag] = secondPlaneDetection_v4(targetPlane,...
...
c_perpendicularity = searchCandidates_perp(frame_tp, element_tp, searchSpaceT, planesDescriptor, th_angle);
if ~isempty(c_perpendicularity)
    % select candidates by convexity criterion
    c_convexity=searchCandidates_conv(c_perpendicularity, frame_tp, element_tp, planesDescriptor);
