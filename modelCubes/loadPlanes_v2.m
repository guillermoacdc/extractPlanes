function [myPlanes acceptedPlanesByFrame rejectedPlanesByFrame groundNormal groundD ]=loadPlanes_v2(myPlanes, in_planesFolderPath, numberPlanes, scene, frame, parameters_PK, lengthBounds, groundNormal, groundD, mode)
