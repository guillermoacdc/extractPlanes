...
% _v3: adds the angle btwn normal point and [0 0 1 ] as a descriptor for the clustering algorithm.
% results are not as discriminative as i was expecting. The algorithm count
% the number of boxes but not the number of planes
clc
close all
clear 
...
X=[nonGroundPtCloud.Location(:,1), nonGroundPtCloud.Location(:,2), ...
    nonGroundPtCloud.Location(:,3), cosAlpha];
