...
% load initial pose
planeGroup=0;
planeDesc_m=loadInitialPose_v3(rootPath,scene,frame,planeGroup);
% compute Tm2h
Th2m=loadTh2m(rootPath,scene);
Tm2h=inv(Th2m);
% project poses
...
% plot
figure,
    myPlotPlanes_v2(localPlanes,allPlanes, true)
    hold on
    dibujarsistemaref(q_c_mm,'h',150,2,10,'w')
    % plot
...
acceptedPlanes=[frame 5; frame 9; frame 15; frame 6; frame 12];
