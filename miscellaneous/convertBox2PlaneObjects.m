function [planeDescriptor] = convertBox2PlaneObjects(myBox,sessionID, ...
...
for i=1:Nsides
    ...
    planeDTemp=computePlaneDescriptorsFromBoxObject(myBox,sessionID, dataSetPath,planeGroup);
