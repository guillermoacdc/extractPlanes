function [numberOfObjects, clusterDescriptor, pc_raw] = countObjectsInPC_v6(sessionID, frameID, typeObject,...
...
[modelGround,inlierIndices,outlierIndices]=pcfitplane(pc_m,th_distance,[0 0 1]);
