function [initialPoses] = loadInitialPose_v2(dataSetPath,sessionID,frame,planesGroup)
...
% v2: operates with a new input: planesGroup:{0 1 2}
% 0: top planes
...
for i=1:Nb
    ...
    for j=1:Npt
        ...
        planeDescriptor=convertPK2PlaneObjects_v4(dataSetPath,sessionID,planeType,frame,boxID);
