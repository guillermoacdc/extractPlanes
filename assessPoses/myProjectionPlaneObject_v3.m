function estimatedPlanes_m = myProjectionPlaneObject_v3(estimatedPlanes,sessionID,dataSetPath)
%MYPROJECTIONPLANEOBJECT Projects estimated poses of accepted planes to qm 
% To solve:
% 1. el centro geométrico no es proyectado, en consecuencia, las etiquetas son impresas distantes del plano proyectado
% 2. Los planos superiores son graficados com planos laterales. type invertido
% 3. Los planos laterales son rotados 90 grados... L2Toy invertido 
...
for i=1:Nep
    ...
    estimatedPlane.geometricCenter=Th2m*[estimatedPlane.geometricCenter'; 1];
    estimatedPlane.geometricCenter(4)=[];
