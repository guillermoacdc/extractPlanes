...
p1=myPlanes{box.side1PlaneID}.geometricCenter;
n1=myPlanes{box.side1PlaneID}.unitNormal';
p2=myPlanes{box.side2PlaneID}.geometricCenter;
n2=myPlanes{box.side2PlaneID}.unitNormal';
p3=myPlanes{box.topPlaneID}.geometricCenter;
n3=myPlanes{box.topPlaneID}.unitNormal';
...
modelParameters=[myPlanes{box.side1PlaneID}.unitNormal myPlanes{box.side1PlaneID}.D];
pc1 = projectInPlane(pc1,modelParameters);

pc2 = pcread(myPlanes{box.side2PlaneID}.pathPoints);%in [mt]; indices begin at 0
modelParameters=[myPlanes{box.side2PlaneID}.unitNormal myPlanes{box.side2PlaneID}.D];
pc2 = projectInPlane(pc2,modelParameters);

pc3 = pcread(myPlanes{box.topPlaneID}.pathPoints);%in [mt]; indices begin at 0
modelParameters=[myPlanes{box.topPlaneID}.unitNormal myPlanes{box.topPlaneID}.D];
