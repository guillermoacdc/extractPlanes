function [secondPlaneIndex] = secondPlaneDetection(targetPlane,acceptedPlanes,planesDescriptor)
...
for(i=1:1:length(candidates1))
    convFlag=convexityCheck([planesDescriptor{targetPlane}.A,...
        planesDescriptor{targetPlane}.B,...
        planesDescriptor{targetPlane}.C],...
        planesDescriptor{targetPlane}.geometricCenter,...
        [planesDescriptor{searchSpace(candidates1(i))}.A,...
        planesDescriptor{searchSpace(candidates1(i))}.B,...
        planesDescriptor{searchSpace(candidates1(i))}.C],...
