function [L1 L2 tform] = computeL1L2(pc, typeOfPlane, modelParameters)
...
if(typeOfPlane==0)%parallel to ground plane
    [L1 L2 tform]=computeL1L2Parallel(pc, typeOfPlane, modelParameters,1);
elseif (typeOfPlane==1 | typeOfPlane==2)%perpendicular planes
    [L1 L2 tform]=computeL1L2Perpendicular(pc, typeOfPlane, modelParameters,1);
