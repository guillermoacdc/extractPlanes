function  cuboidDetection_pair_v7(globalPlanes, th_angle, ...
...
if ~isempty(couple1) & ~isempty(ss_couple1)
    searchThirdPlane(globalPlanes, couple1, ss_couple1, th_angle);%designed to use pass by reference in globalPlanes
end

if ~isempty(couple2) & ~isempty(ss_couple2)
    searchThirdPlane(globalPlanes, couple2, ss_couple2, th_angle);
end

if ~isempty(couple3) & ~isempty(ss_couple3)
    searchThirdPlane(globalPlanes, couple3, ss_couple3, th_angle);
end
