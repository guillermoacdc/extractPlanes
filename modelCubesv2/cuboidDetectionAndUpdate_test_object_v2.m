...
%     tic;
    [localPlanes,Nnap] = detectAndFilterPlaneSegments(sessionID,frameID, planeFilteringParameters, compensateFactor);
%%     save estimations
...
myDisplayGroups(globalPlanes, group_tpp, group_tp, group_s);
