function adjustPoseOrthogonal_v3(globalPlanes,group_tpp, sidesVector)
...
adjustSinglePoseOrthogonal(globalPlanes, [group_tpp(1),group_tpp(2)], sidesVector(2));
% adjust single pose for second perpendicular plane
adjustSinglePoseOrthogonal(globalPlanes, [group_tpp(1),group_tpp(3)], sidesVector(3));
end
