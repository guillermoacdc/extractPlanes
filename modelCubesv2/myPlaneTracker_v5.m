function [globalEstimations_plane, localEstimations_plane]=myPlaneTracker_v5(sessionID, ...
...
% The outputs are returned in the struct globalEstimations_plane 
% The inputs
%   sessionID, 
...
globalEstimations_plane.Parameteres.MergingPlane.tao=tao_merg;
globalEstimations_plane.Parameteres.MergingPlane.theta=theta_merg;
globalEstimations_plane.Parameteres.MergingPlane.gridStep=gridStep;
...
globalEstimations_plane.Parameteres.Particles.windowSize=windowSize;
globalEstimations_plane.Parameteres.Particles.th_vigency=th_vigency;
...
globalEstimations_plane.Parameteres.DepthCamera_range=th_distance_depthCamera;
conditionalAssignationFlag=0;
%% begin Text
disp(['----------Estimating poses in session ' num2str(sessionID) ])
globalEstimations_plane.sessionID=sessionID;
...
globalEstimations_plane.keyFrames=keyframes;
localEstimations_plane.keyFrames=keyframes;
...
%     globalEstimations_plane.(['frame' num2str(frameID)]).values=obj2struct_vector(globalPlanes); 
    globalEstimations_plane.(['frame' num2str(frameID)]).values=obj2struct(globalPlanes); 
    globalEstimations_plane.(['frame' num2str(frameID)]).Nnap=Nnap;
    localEstimations_plane.(['frame' num2str(frameID)]).values=obj2struct(localPlanes); 
    localEstimations_plane.(['frame' num2str(frameID)]).Nnap=Nnap;
end
