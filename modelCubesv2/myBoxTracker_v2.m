function myBoxTracker_v2(sessionID, outputFileNameBoxes, outputFileNamePlanes, planeFilteringParameters, ...
...
mySaveStruct2JSONFile(estimatedBoxPose,outputFileNameBoxes,evalPath,sessionID);
mySaveStruct2JSONFile(estimatedBoxPose,outputFileNamePlanes,evalPath,sessionID);
