...
int main()
{
	...
	std::string writePath = rootPath + "outputPlanes_t10\\";
	...
	modelCoeffs = extractGround(raw_pc, boxes_pc, ground_pc, groundCentroid, DistanceTreshold);//source of the assertion error; this error was resolved by enabling vcpkg in project/properties
